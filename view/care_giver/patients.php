...
if (isset($_GET['delete_patient'])) {
    ...
    if ($isDeleted) {
      // Redirect to the original page (with updated data)
      header('Location: patients.php'); // Replace with your actual page URL
    } else {
                                                                    ...
                                                                    foreach ($patients as $index => $patient) {
                                                                        if($patient['care_giver_id']== $care_giver_id){
                                                                            ...
                                                                            echo "<td>
                                                                                    ...
                                                                                    <a href='?delete_patient=".$patient['id']."'  class='border text-danger btn-sm'><i class='fa-regular fa-trash-can'></i></a>
